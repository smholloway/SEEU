 ...
 */
With our existing Sun SPOT Java code, sensors and actuators both use HTTP GET. This breaks with the otherwise RESTful architecture; to acommodate the change, I edited the routes to accept posting with GET rather than editing the SPOT code, which I believe is less stable.
